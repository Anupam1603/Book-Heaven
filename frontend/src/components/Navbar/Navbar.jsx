...
const Navbar = () => {
  ...
  return (
    <>
      <nav className=" z-50 relative flex items-center  justify-between bg-zinc-800 text-white px-8 py-2">
      ...
      >
        ...
        <Link
          to="/Signin"
          className={`${MobileNav} px-8 py-2 mb-8 text:3xl font-semibold border rounded border-blue-500 text-white hover:bg-white hover:text-zinc-800 transition-all transition-duration-300`}
        >
          SignIn
        </Link>
        <Link
          to="/Signup"
          className={`${MobileNav} px-8 py-2 mb-8 text:3xl font-semibold bg-blue-500 rounded hover:bg-white hover:text-zinc-800 transition-all transition-duration-300 `}
        >
          SignUp
        </Link>
      </div>
